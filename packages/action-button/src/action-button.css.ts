...
const styles = css`
    ...
    :host([size='s']) {
        --cm-actionbutton-quiet-border-size: var(
            --cm-actionbutton-s-quiet-border-size,
            var(--cm-alias-border-size-thin)
        );
        --cm-actionbutton-quiet-border-radius: var(
            --cm-actionbutton-s-quiet-border-radius,
            var(--cm-alias-border-radius-regular)
        );
        --cm-actionbutton-quiet-text-font-weight: var(
            --cm-actionbutton-s-quiet-text-font-weight,
            var(--cm-alias-body-text-font-weight)
        );
        --cm-actionbutton-quiet-text-size: var(
            --cm-actionbutton-s-quiet-text-size,
            var(--cm-alias-item-text-size-s)
        );
        --cm-actionbutton-border-size: var(
            --cm-actionbutton-s-border-size,
            var(--cm-alias-border-size-thin)
        );
        --cm-actionbutton-border-radius: var(
            --cm-actionbutton-s-border-radius,
            var(--cm-alias-border-radius-regular)
        );
        --cm-actionbutton-min-width: var(
            --cm-actionbutton-s-min-width,
            var(--cm-global-dimension-size-400)
        );
        --cm-actionbutton-text-font-weight: var(
            --cm-actionbutton-s-text-font-weight,
            var(--cm-alias-body-text-font-weight)
        );
        --cm-actionbutton-text-line-height: var(
            --cm-actionbutton-s-text-line-height,
            var(--cm-alias-component-text-line-height)
        );
        --cm-actionbutton-text-size: var(
            --cm-actionbutton-s-text-size,
            var(--cm-alias-item-text-size-s)
        );
        --cm-actionbutton-icon-gap: var(
            --cm-actionbutton-s-icon-gap,
            var(--cm-alias-item-workflow-icon-gap-s)
        );
        --cm-actionbutton-height: var(
            --cm-actionbutton-s-height,
            var(--cm-alias-item-height-s)
        );
        --cm-actionbutton-padding-left: var(
            --cm-actionbutton-s-padding-left,
            var(--cm-alias-item-workflow-padding-left-s)
        );
        --cm-actionbutton-icononly-padding-left: var(
            --cm-actionbutton-s-icononly-padding-left,
            var(--cm-alias-item-icononly-padding-s)
        );
        --cm-actionbutton-icononly-padding-right: var(
            --cm-actionbutton-s-icononly-padding-right,
            var(--cm-alias-item-icononly-padding-s)
        );
        --cm-actionbutton-textonly-padding-left: var(
            --cm-actionbutton-s-textonly-padding-left,
            var(--cm-alias-item-padding-s)
        );
        --cm-actionbutton-textonly-padding-right: var(
            --cm-actionbutton-s-textonly-padding-right,
            var(--cm-alias-item-padding-s)
        );
        --cm-actionbutton-hold-icon-padding-bottom: var(
            --cm-global-dimension-size-25
        );
        --cm-actionbutton-hold-icon-padding-right: var(
            --cm-global-dimension-size-25
        );
    }
    ...
    :host([size='m']) {
        --cm-actionbutton-quiet-border-size: var(
            --cm-actionbutton-m-quiet-border-size,
            var(--cm-alias-border-size-thin)
        );
        --cm-actionbutton-quiet-border-radius: var(
            --cm-actionbutton-m-quiet-border-radius,
            var(--cm-alias-border-radius-regular)
        );
        --cm-actionbutton-quiet-text-font-weight: var(
            --cm-actionbutton-m-quiet-text-font-weight,
            var(--cm-alias-body-text-font-weight)
        );
        --cm-actionbutton-quiet-text-size: var(
            --cm-actionbutton-m-quiet-text-size,
        ...
        --cm-actionbutton-text-font-weight: var(
            --cm-actionbutton-m-text-font-weight,
            var(--cm-alias-body-text-font-weight)
        );
        --cm-actionbutton-text-line-height: var(
            --cm-actionbutton-m-text-line-height,
            var(--cm-alias-component-text-line-height)
        );
        --cm-actionbutton-text-size: var(
            --cm-actionbutton-m-text-size,
            var(--cm-alias-item-text-size-m)
        );
        --cm-actionbutton-height: var(
            --cm-actionbutton-m-height,
            var(--cm-alias-item-height-m)
        );
        --cm-actionbutton-icon-gap: var(
            --cm-actionbutton-m-icon-gap,
            var(--cm-alias-item-workflow-icon-gap-m)
        );
        --cm-actionbutton-padding-left: var(
            --cm-actionbutton-m-padding-left,
            var(--cm-alias-item-workflow-padding-left-m)
        );
        --cm-actionbutton-icononly-padding-left: var(
            --cm-actionbutton-m-icononly-padding-left,
            var(--cm-alias-item-icononly-padding-m)
        );
        --cm-actionbutton-icononly-padding-right: var(
            --cm-actionbutton-m-icononly-padding-right,
            var(--cm-alias-item-icononly-padding-m)
        );
        --cm-actionbutton-textonly-padding-left: var(
            --cm-actionbutton-m-textonly-padding-left,
            var(--cm-alias-item-padding-m)
        );
        --cm-actionbutton-textonly-padding-right: var(
            --cm-actionbutton-m-textonly-padding-right,
            var(--cm-alias-item-padding-m)
        );
        --cm-actionbutton-hold-icon-padding-bottom: var(
    ...
    :host([size='l']) {
        --cm-actionbutton-quiet-border-size: var(
            --cm-actionbutton-l-quiet-border-size,
            var(--cm-alias-border-size-thin)
        );
        --cm-actionbutton-quiet-border-radius: var(
            --cm-actionbutton-l-quiet-border-radius,
            var(--cm-alias-border-radius-regular)
        );
        --cm-actionbutton-quiet-text-font-weight: var(
            --cm-actionbutton-l-quiet-text-font-weight,
            var(--cm-alias-body-text-font-weight)
        );
        --cm-actionbutton-quiet-text-size: var(
            --cm-actionbutton-l-quiet-text-size,
            var(--cm-alias-item-text-size-l)
        );
        --cm-actionbutton-border-size: var(
            --cm-actionbutton-l-border-size,
            var(--cm-alias-border-size-thin)
        );
        --cm-actionbutton-border-radius: var(
            --cm-actionbutton-l-border-radius,
            var(--cm-alias-border-radius-regular)
        );
        --cm-actionbutton-min-width: var(
            --cm-actionbutton-l-min-width,
            var(--cm-global-dimension-size-400)
        );
        --cm-actionbutton-text-font-weight: var(
            --cm-actionbutton-l-text-font-weight,
            var(--cm-alias-body-text-font-weight)
        );
        --cm-actionbutton-text-line-height: var(
            --cm-actionbutton-l-text-line-height,
            var(--cm-alias-component-text-line-height)
        );
        --cm-actionbutton-text-size: var(
            --cm-actionbutton-l-text-size,
            var(--cm-alias-item-text-size-l)
        );
        --cm-actionbutton-icon-gap: var(
            --cm-actionbutton-l-icon-gap,
            var(--cm-alias-item-workflow-icon-gap-l)
        );
        --cm-actionbutton-height: var(
            --cm-actionbutton-l-height,
            var(--cm-alias-item-height-l)
        );
        --cm-actionbutton-padding-left: var(
            --cm-actionbutton-l-padding-left,
            var(--cm-alias-item-workflow-padding-left-l)
        );
        --cm-actionbutton-icononly-padding-left: var(
            --cm-actionbutton-l-icononly-padding-left,
            var(--cm-alias-item-icononly-padding-l)
        );
        --cm-actionbutton-icononly-padding-right: var(
            --cm-actionbutton-l-icononly-padding-right,
            var(--cm-alias-item-icononly-padding-l)
        );
        --cm-actionbutton-textonly-padding-left: var(
            --cm-actionbutton-l-textonly-padding-left,
            var(--cm-alias-item-padding-l)
        );
        --cm-actionbutton-textonly-padding-right: var(
            --cm-actionbutton-l-textonly-padding-right,
            var(--cm-alias-item-padding-l)
        );
        --cm-actionbutton-hold-icon-padding-bottom: var(
    ...
    :host([size='xl']) {
        --cm-actionbutton-quiet-border-size: var(
            --cm-actionbutton-xl-quiet-border-size,
            var(--cm-alias-border-size-thin)
        );
        --cm-actionbutton-quiet-border-radius: var(
            --cm-actionbutton-xl-quiet-border-radius,
            var(--cm-alias-border-radius-regular)
        );
        --cm-actionbutton-quiet-text-font-weight: var(
            --cm-actionbutton-xl-quiet-text-font-weight,
            var(--cm-alias-body-text-font-weight)
        );
        --cm-actionbutton-quiet-text-size: var(
            --cm-actionbutton-xl-quiet-text-size,
            var(--cm-alias-item-text-size-xl)
        );
        --cm-actionbutton-border-size: var(
            --cm-actionbutton-xl-border-size,
            var(--cm-alias-border-size-thin)
        );
        --cm-actionbutton-border-radius: var(
            --cm-actionbutton-xl-border-radius,
            var(--cm-alias-border-radius-regular)
        );
        --cm-actionbutton-min-width: var(
            --cm-actionbutton-xl-min-width,
            var(--cm-global-dimension-size-400)
        );
        --cm-actionbutton-text-font-weight: var(
            --cm-actionbutton-xl-text-font-weight,
            var(--cm-alias-body-text-font-weight)
        );
        --cm-actionbutton-text-line-height: var(
            --cm-actionbutton-xl-text-line-height,
            var(--cm-alias-component-text-line-height)
        );
        --cm-actionbutton-icon-gap: var(
            --cm-actionbutton-xl-icon-gap,
            var(--cm-alias-item-workflow-icon-gap-l)
        );
        --cm-actionbutton-text-size: var(
            --cm-actionbutton-xl-text-size,
            var(--cm-alias-item-text-size-xl)
        );
        --cm-actionbutton-height: var(
            --cm-actionbutton-xl-height,
            var(--cm-alias-item-height-xl)
        );
        --cm-actionbutton-padding-left: var(
            --cm-actionbutton-xl-padding-left,
            var(--cm-alias-item-workflow-padding-left-xl)
        );
        --cm-actionbutton-icononly-padding-left: var(
            --cm-actionbutton-xl-icononly-padding-left,
            var(--cm-alias-item-icononly-padding-xl)
        );
        --cm-actionbutton-icononly-padding-right: var(
            --cm-actionbutton-xl-icononly-padding-right,
            var(--cm-alias-item-icononly-padding-xl)
        );
        --cm-actionbutton-textonly-padding-left: var(
            --cm-actionbutton-xl-textonly-padding-left,
            var(--cm-alias-item-padding-xl)
        );
        --cm-actionbutton-textonly-padding-right: var(
            --cm-actionbutton-xl-textonly-padding-right,
            var(--cm-alias-item-padding-xl)
        );
        --cm-actionbutton-hold-icon-padding-bottom: var(
    ...
    :host {
        --cm-actionbutton-padding-left-adjusted: calc(
            var(--cm-actionbutton-padding-left) -
                var(--cm-actionbutton-border-size)
        );
        --cm-actionbutton-textonly-padding-left-adjusted: calc(
            var(--cm-actionbutton-textonly-padding-left) -
                var(--cm-actionbutton-border-size)
        );
        --cm-actionbutton-textonly-padding-right-adjusted: calc(
            var(--cm-actionbutton-textonly-padding-right) -
                var(--cm-actionbutton-border-size)
        );
        --cm-actionbutton-icononly-padding-left-adjusted: calc(
            var(--cm-actionbutton-icononly-padding-left) -
                var(--cm-actionbutton-border-size)
        );
        --cm-actionbutton-icononly-padding-right-adjusted: calc(
            var(--cm-actionbutton-icononly-padding-right) -
                var(--cm-actionbutton-border-size)
        );
    }
    ...
    :host([dir='ltr']) ::slotted([slot='icon']) {
        margin-left: calc(
            -1 * (var(--cm-actionbutton-textonly-padding-left-adjusted) -
                        var(--cm-actionbutton-padding-left-adjusted))
        );
    }
    ...
    :host([dir]) slot[icon-only] sp-icon {
        margin-left: calc(
            -1 * (var(--cm-actionbutton-textonly-padding-left-adjusted) -
                        var(--cm-actionbutton-icononly-padding-left-adjusted))
        );
        margin-right: calc(
            -1 * (var(--cm-actionbutton-textonly-padding-right-adjusted) -
                        var(--cm-actionbutton-icononly-padding-right-adjusted))
        );
    }
    ...
    :host {
        ...
        background-color: var(
            --cm-actionbutton-m-background-color,
            var(--cm-global-color-gray-A300)
        );
        border-color: var(
            --cm-actionbutton-m-border-color,
    ...
    #hold-affordance {
        color: var(
            --cm-actionbutton-m-hold-icon-color,
    ...
    :host(:hover) {
        background-color: var(
            --cm-actionbutton-m-background-color-hover,
            var(--cm-global-color-gray-50)
        );
        border-color: var(
            --cm-actionbutton-m-border-color-hover,
            var(--cm-alias-border-color-hover)
        );
        color: var(
            --cm-actionbutton-m-text-color-hover,
            var(--cm-alias-text-color-hover)
        );
    }

    :host(:hover) ::slotted([slot='icon']) {
        color: var(
            --cm-actionbutton-m-icon-color-hover,
    ...
    :host(:hover) #hold-affordance {
        color: var(
            --cm-actionbutton-m-hold-icon-color-hover,
            var(--cm-alias-icon-color-hover)
        );
    }
    ...
    :host(.focus-visible) {
        background-color: var(
            --cm-actionbutton-m-background-color-key-focus,
            var(--cm-global-color-gray-50)
        );
        box-shadow: 0 0 0
            var(
                --cm-actionbutton-m-quiet-border-size-key-focus,
                var(--cm-alias-border-size-thick)
            )
            var(
                --cm-actionbutton-m-border-color-key-focus,
                var(--cm-alias-border-color-focus)
            );
        color: var(
            --cm-actionbutton-m-text-color-key-focus,
            var(--cm-alias-text-color-hover)
        );
    }
    ...
    :host(.focus-visible) ::slotted([slot='icon']) {
        color: var(
            --cm-actionbutton-m-icon-color-key-focus,
    ...
    :host(.focus-visible) #hold-affordance {
        color: var(
            --cm-actionbutton-m-hold-icon-color-key-focus,
            var(--cm-alias-icon-color-hover)
        );
    }
    ...
    :host([active]) {
        background-color: var(
            --cm-actionbutton-m-background-color-down,
            var(--cm-global-color-gray-200)
        );
        border-color: var(
            --cm-actionbutton-m-border-color-down,
            var(--cm-alias-border-color-down)
        );
        color: var(
            --cm-actionbutton-m-text-color-down,
            var(--cm-alias-text-color-down)
        );
    }

    :host([active]) #hold-affordance {
        color: var(
            --cm-actionbutton-m-hold-icon-color-down,
    ...
    :host([disabled]) {
        background-color: var(
            --cm-actionbutton-m-background-color-disabled,
            var(--cm-global-color-gray-200)
        );
        border-color: var(
            --cm-actionbutton-m-border-color-disabled,
            var(--cm-alias-border-color-disabled)
        );
        color: var(
            --cm-actionbutton-m-text-color-disabled,
    ...
    :host([disabled]) ::slotted([slot='icon']) {
        color: var(
            --cm-actionbutton-m-icon-color-disabled,
    ...
    :host([disabled]) #hold-affordance {
        color: var(
            --cm-actionbutton-m-hold-icon-color-disabled,
            var(--cm-alias-icon-color-disabled)
        );
    }
    ...
    :host([selected]) {
        background-color: var(
            --cm-actionbutton-m-background-color-selected,
            var(--cm-global-color-gray-200)
        );
        border-color: var(
            --cm-actionbutton-m-border-color-selected,
            var(--cm-alias-border-color)
        );
        color: var(
            --cm-actionbutton-m-text-color-selected,
            var(--cm-alias-text-color)
        );
    }

    :host([selected]) ::slotted([slot='icon']) {
        color: var(
            --cm-actionbutton-m-icon-color-selected,
            var(--cm-alias-icon-color)
        );
    }
    ...
    :host([selected].focus-visible) {
        background-color: var(
            --cm-actionbutton-m-background-color-selected-key-focus,
            var(--cm-global-color-gray-200)
        );
        border-color: var(
            --cm-actionbutton-m-border-color-selected-key-focus,
            var(--cm-alias-border-color-focus)
        );
        color: var(
            --cm-actionbutton-m-text-color-selected-key-focus,
            var(--cm-alias-text-color-hover)
        );
    }
    ...
    :host([selected].focus-visible) ::slotted([slot='icon']) {
        color: var(
            --cm-actionbutton-m-icon-color-selected-key-focus,
            var(--cm-alias-icon-color-hover)
        );
    }
    ...
    :host([selected]:hover) {
        background-color: var(
            --cm-actionbutton-m-background-color-selected-hover,
            var(--cm-global-color-gray-200)
        );
        border-color: var(
            --cm-actionbutton-m-border-color-selected-hover,
            var(--cm-alias-border-color-hover)
        );
        color: var(
            --cm-actionbutton-m-text-color-selected-hover,
            var(--cm-alias-text-color-hover)
        );
    }
    ...
    :host([selected]:hover) ::slotted([slot='icon']) {
        color: var(
            --cm-actionbutton-m-icon-color-selected-hover,
            var(--cm-alias-icon-color-hover)
        );
    }
    ...
    :host([selected][active]) {
        background-color: var(
            --cm-actionbutton-m-background-color-selected-down,
            var(--cm-global-color-gray-200)
        );
        border-color: var(
            --cm-actionbutton-m-border-color-selected-down,
            var(--cm-alias-border-color-down)
        );
        color: var(
            --cm-actionbutton-m-text-color-selected-down,
            var(--cm-alias-text-color-down)
        );
    }
    ...
    :host([selected][active]) ::slotted([slot='icon']) {
        color: var(
            --cm-actionbutton-m-icon-color-selected-down,
            var(--cm-alias-icon-color-down)
        );
    }
    ...
    :host([selected][disabled]) {
        background-color: var(
            --cm-actionbutton-m-background-color-selected-disabled,
            var(--cm-global-color-gray-200)
        );
        border-color: var(
            --cm-actionbutton-m-border-color-selected-disabled,
            var(--cm-alias-border-color-disabled)
        );
        color: var(
            --cm-actionbutton-m-text-color-selected-disabled,
            var(--cm-alias-text-color-disabled)
        );
    }
    ...
    :host([selected][disabled]) ::slotted([slot='icon']) {
        color: var(
            --cm-actionbutton-m-icon-color-selected-disabled,
            var(--cm-alias-icon-color-disabled)
        );
    }
    ...
    :host([emphasized]) {
        background-color: var(
            --cm-actionbutton-m-emphasized-background-color,
            var(--cm-global-color-gray-75)
        );
        border-color: var(
            --cm-actionbutton-m-emphasized-border-color,
            var(--cm-alias-border-color)
        );
        color: var(
            --cm-actionbutton-m-emphasized-text-color,
            var(--cm-alias-text-color)
        );
    }
    ...
    :host([emphasized]) ::slotted([slot='icon']) {
        color: var(
            --cm-actionbutton-m-emphasized-icon-color,
            var(--cm-alias-icon-color)
        );
    }
    ...
    :host([emphasized]) #hold-affordance {
        color: var(
            --cm-actionbutton-m-emphasized-hold-icon-color,
            var(--cm-alias-icon-color)
        );
    }
    ...
    :host([emphasized][selected]) #hold-affordance {
        color: var(
            --cm-actionbutton-m-emphasized-hold-icon-color-selected,
    ...
    :host([emphasized][selected]:hover) #hold-affordance {
        color: var(
            --cm-actionbutton-m-emphasized-text-color-selected-hover,
            var(--cm-global-color-static-white)
        );
    }
    ...
    :host([emphasized]:hover) {
        background-color: var(
            --cm-actionbutton-m-emphasized-background-color-hover,
            var(--cm-global-color-gray-50)
        );
        border-color: var(
            --cm-actionbutton-m-emphasized-border-color-hover,
            var(--cm-alias-border-color-hover)
        );
        box-shadow: none;
        color: var(
            --cm-actionbutton-m-emphasized-text-color-hover,
            var(--cm-alias-text-color-hover)
        );
    }
    ...
    :host([emphasized]:hover) ::slotted([slot='icon']) {
        color: var(
            --cm-actionbutton-m-emphasized-icon-color-hover,
            var(--cm-alias-icon-color-hover)
        );
    }
    ...
    :host([emphasized]:hover) #hold-affordance {
        color: var(
            --cm-actionbutton-m-emphasized-hold-icon-color-hover,
            var(--cm-alias-icon-color-hover)
        );
    }
    ...
    :host([emphasized].focus-visible) {
        background-color: var(
            --cm-actionbutton-m-emphasized-background-color-key-focus,
            var(--cm-global-color-gray-50)
        );
        border-color: var(
            --cm-actionbutton-m-emphasized-border-color-key-focus,
            var(--cm-alias-border-color-hover)
        );
        box-shadow: 0 0 0
            var(
        ...
        color: var(
            --cm-actionbutton-m-emphasized-text-color-key-focus,
            var(--cm-alias-text-color-hover)
        );
    }
    ...
    :host([emphasized].focus-visible) ::slotted([slot='icon']) {
        color: var(
            --cm-actionbutton-m-emphasized-icon-color-key-focus,
            var(--cm-alias-icon-color-focus)
        );
    }
    ...
    :host([emphasized].focus-visible) #hold-affordance {
        color: var(
            --cm-actionbutton-m-emphasized-hold-icon-color-key-focus,
            var(--cm-alias-icon-color-hover)
        );
    }
    ...
    :host([emphasized][active]) {
        background-color: var(
            --cm-actionbutton-m-emphasized-background-color-down,
            var(--cm-global-color-gray-200)
        );
        border-color: var(
            --cm-actionbutton-m-emphasized-border-color-down,
            var(--cm-alias-border-color-down)
        );
        box-shadow: none;
        color: var(
            --cm-actionbutton-m-emphasized-text-color-down,
            var(--cm-alias-text-color-down)
        );
    }
    ...
    :host([emphasized][active]) #hold-affordance {
        color: var(
            --cm-actionbutton-m-emphasized-hold-icon-color-down,
            var(--cm-alias-icon-color-down)
        );
    }
    ...
    :host([emphasized][disabled]) {
        background-color: var(
            --cm-actionbutton-m-emphasized-background-color-disabled,
            var(--cm-global-color-gray-200)
        );
        border-color: var(
            --cm-actionbutton-m-emphasized-border-color-disabled,
            var(--cm-alias-border-color-disabled)
        );
        color: var(
            --cm-actionbutton-m-emphasized-text-color-disabled,
            var(--cm-alias-text-color-disabled)
        );
    }
    ...
    :host([emphasized][disabled]) ::slotted([slot='icon']) {
        color: var(
            --cm-actionbutton-m-emphasized-icon-color-disabled,
            var(--cm-alias-icon-color-disabled)
        );
    }
    ...
    :host([emphasized][disabled]) #hold-affordance {
        color: var(
            --cm-actionbutton-m-emphasized-hold-icon-color-disabled,
            var(--cm-alias-icon-color-disabled)
        );
    }
    ...
    :host([emphasized][selected]) {
        background-color: var(
            --cm-actionbutton-m-emphasized-background-color-selected,
            var(--cm-semantic-cta-color-background-default)
        );
        border-color: var(
            --cm-actionbutton-m-emphasized-border-color-selected,
            var(--cm-semantic-cta-color-background-default)
        );
        color: var(
            --cm-actionbutton-m-emphasized-text-color-selected,
            var(--cm-global-color-static-white)
        );
    }
    ...
    :host([emphasized][selected]) ::slotted([slot='icon']) {
        color: var(
            --cm-actionbutton-m-emphasized-icon-color-selected,
            var(--cm-global-color-static-white)
        );
    }
    ...
    :host([emphasized][selected].focus-visible) {
        background-color: var(
            --cm-actionbutton-m-emphasized-background-color-selected-key-focus,
            var(--cm-semantic-cta-color-background-key-focus)
        );
        border-color: var(
            --cm-actionbutton-m-emphasized-border-color-selected-key-focus,
            var(--cm-semantic-cta-color-background-key-focus)
        );
        color: var(
            --cm-actionbutton-m-emphasized-text-color-selected-key-focus,
            var(--cm-global-color-static-white)
        );
    }
    ...
    :host([emphasized][selected].focus-visible) ::slotted([slot='icon']) {
        color: var(
            --cm-actionbutton-m-emphasized-icon-color-selected-key-focus,
            var(--cm-global-color-static-white)
        );
    }
    ...
    :host([emphasized][selected]:hover) {
        background-color: var(
            --cm-actionbutton-m-emphasized-background-color-selected-hover,
            var(--cm-semantic-cta-color-background-hover)
        );
        border-color: var(
            --cm-actionbutton-m-emphasized-border-color-selected-hover,
            var(--cm-semantic-cta-color-background-hover)
        );
        color: var(
            --cm-actionbutton-m-emphasized-text-color-selected-hover,
    ...
    :host([emphasized][selected]:hover) ::slotted([slot='icon']) {
        color: var(
            --cm-actionbutton-m-emphasized-icon-color-selected-hover,
            var(--cm-global-color-static-white)
        );
    }
    ...
    :host([emphasized][selected][active]) {
        background-color: var(
            --cm-actionbutton-m-emphasized-background-color-selected-down,
            var(--cm-semantic-cta-color-background-down)
        );
        border-color: var(
            --cm-actionbutton-m-emphasized-border-color-selected-down,
            var(--cm-semantic-cta-color-background-down)
        );
        color: var(
            --cm-actionbutton-m-emphasized-text-color-selected-down,
            var(--cm-global-color-static-white)
        );
    }
    ...
    :host([emphasized][selected][active]) ::slotted([slot='icon']) {
        color: var(
            --cm-actionbutton-m-emphasized-icon-color-selected-down,
            var(--cm-global-color-static-white)
        );
    }
    ...
    :host([emphasized][selected][disabled]) {
        background-color: var(
            --cm-actionbutton-m-emphasized-background-color-selected-disabled,
            var(--cm-global-color-gray-200)
        );
        border-color: var(
            --cm-actionbutton-m-emphasized-border-color-selected-disabled,
            var(--cm-alias-border-color-disabled)
        );
        color: var(
            --cm-actionbutton-m-emphasized-text-color-selected-disabled,
            var(--cm-alias-text-color-disabled)
        );
    }
    ...
    :host([emphasized][selected][disabled]) ::slotted([slot='icon']) {
        color: var(
            --cm-actionbutton-m-emphasized-icon-color-selected-disabled,
            var(--cm-alias-icon-color-disabled)
        );
    }
    ...
    :host([quiet]) {
        background-color: var(
            --cm-actionbutton-m-quiet-background-color,
            var(--cm-alias-background-color-transparent)
        );
        border-color: var(
            --cm-actionbutton-m-quiet-border-color,
            var(--cm-alias-border-color-transparent)
        );
        color: var(
            --cm-actionbutton-m-quiet-text-color,
            var(--cm-alias-text-color)
        );
    }
    ...
    :host([quiet]:hover) {
        background-color: var(
            --cm-actionbutton-m-quiet-background-color-hover,
            var(--cm-alias-background-color-transparent)
        );
        border-color: var(
            --cm-actionbutton-m-quiet-border-color-hover,
            var(--cm-alias-border-color-transparent)
        );
        color: var(
            --cm-actionbutton-m-quiet-text-color-hover,
            var(--cm-alias-text-color-hover)
        );
    }
    ...
    :host([quiet].focus-visible) {
        background-color: var(
            --cm-actionbutton-m-quiet-background-color-key-focus,
            var(--cm-alias-background-color-transparent)
        );
        box-shadow: 0 0 0
            var(
            ...
            var(
                --cm-actionbutton-m-quiet-border-color-key-focus,
                var(--cm-alias-border-color-focus)
            );
        border-color: var(
            --cm-actionbutton-m-quiet-border-color-key-focus,
        ...
        color: var(
            --cm-actionbutton-m-quiet-text-color-key-focus,
            var(--cm-alias-text-color-hover)
        );
    }
    ...
    :host([quiet][active]) {
        background-color: var(
            --cm-actionbutton-m-quiet-background-color-down,
            var(--cm-global-color-gray-300)
        );
        border-color: var(
            --cm-actionbutton-m-quiet-border-color-down,
            var(--cm-alias-border-color-transparent)
        );
        color: var(
            --cm-actionbutton-m-quiet-text-color-down,
            var(--cm-alias-text-color-down)
        );
    }
    ...
    :host([quiet][disabled]) {
        background-color: var(
            --cm-actionbutton-m-quiet-background-color-disabled,
            var(--cm-alias-background-color-transparent)
        );
        border-color: var(
            --cm-actionbutton-m-quiet-border-color-disabled,
            var(--cm-alias-border-color-transparent)
        );
        color: var(
            --cm-actionbutton-m-quiet-text-color-disabled,
            var(--cm-alias-text-color-disabled)
        );
    }
    ...
    :host([quiet][selected]) {
        background-color: var(
            --cm-actionbutton-m-quiet-background-color-selected,
            var(--cm-global-color-gray-200)
        );
        border-color: var(
            --cm-actionbutton-m-quiet-border-color-selected,
            var(--cm-alias-border-color-transparent)
        );
        color: var(
            --cm-actionbutton-m-quiet-text-color-selected,
            var(--cm-alias-text-color)
        );
    }
    ...
    :host([quiet][selected].focus-visible) {
        background-color: var(
            --cm-actionbutton-m-quiet-background-color-selected-key-focus,
            var(--cm-global-color-gray-200)
        );
        border-color: var(
            --cm-actionbutton-m-quiet-border-color-selected-key-focus,
            var(--cm-alias-border-color-transparent)
        );
        color: var(
            --cm-actionbutton-m-quiet-text-color-selected-key-focus,
            var(--cm-alias-text-color-hover)
        );
    }
    ...
    :host([quiet][selected]:hover) {
        background-color: var(
            --cm-actionbutton-m-quiet-background-color-selected-hover,
            var(--cm-global-color-gray-200)
        );
        border-color: var(
            --cm-actionbutton-m-quiet-border-color-selected-hover,
            var(--cm-alias-border-color-transparent)
        );
        color: var(
            --cm-actionbutton-m-quiet-text-color-selected-hover,
            var(--cm-alias-text-color-hover)
        );
    }
    ...
    :host([quiet][selected][active]) {
        background-color: var(
            --cm-actionbutton-m-quiet-background-color-selected-down,
            var(--cm-global-color-gray-200)
        );
        border-color: var(
            --cm-actionbutton-m-quiet-border-color-selected-down,
            var(--cm-alias-border-color-transparent)
        );
        color: var(
            --cm-actionbutton-m-quiet-text-color-selected-down,
            var(--cm-alias-text-color-down)
        );
    }
    ...
    :host([quiet][selected][disabled]) {
        background-color: var(
            --cm-actionbutton-m-quiet-background-color-selected-disabled,
            var(--cm-global-color-gray-200)
        );
        border-color: var(
            --cm-actionbutton-m-quiet-border-color-selected-disabled,
            var(--cm-alias-border-color-transparent)
        );
        color: var(
            --cm-actionbutton-m-quiet-text-color-selected-disabled,
            var(--cm-alias-text-color-disabled)
        );
    }
    ...
    #label {
        flex-grow: var(--cm-actionbutton-label-flex-grow);
        text-align: var(--cm-actionbutton-label-text-align);
    }
