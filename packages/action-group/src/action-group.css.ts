...
const styles = css`
    ...
    :host([compact]:not([quiet])) ::slotted(:not([role])) {
        --cm-actionbutton-m-border-radius: 0;
        --cm-actionbutton-s-border-radius: var(
            --cm-actionbutton-m-border-radius
        );
        --cm-actionbutton-l-border-radius: var(
            --cm-actionbutton-m-border-radius
        );
        --cm-actionbutton-xl-border-radius: var(
            --cm-actionbutton-m-border-radius
        );
    }
    :host([compact][vertical]:not([quiet]))
        ::slotted(:not([role]):first-child) {
        --cm-actionbutton-m-border-radius: var(--cm-alias-border-radius-regular)
            var(--cm-alias-border-radius-regular) 0 0;
    }
    :host([compact][vertical]:not([quiet])) ::slotted(:not([role]):last-child) {
        --cm-actionbutton-m-border-radius: 0 0
            var(--cm-alias-border-radius-regular)
            var(--cm-alias-border-radius-regular);
    }
    :host([dir='ltr'][compact]:not([quiet]):not([vertical]))
        ::slotted(:not([role]):first-child) {
        --cm-actionbutton-m-border-radius: var(--cm-alias-border-radius-regular)
            0 0 var(--cm-alias-border-radius-regular);
    }
    :host([dir='rtl'][compact]:not([quiet]):not([vertical]))
        ::slotted(:not([role]):first-child) {
        --cm-actionbutton-m-border-radius: 0
            var(--cm-alias-border-radius-regular)
            var(--cm-alias-border-radius-regular) 0;
    }
    :host([dir='ltr'][compact]:not([quiet]):not([vertical]))
